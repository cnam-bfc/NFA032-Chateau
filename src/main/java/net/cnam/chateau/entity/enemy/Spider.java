...
public class Spider extends Enemy {
    ...
    public Spider(Console console, Stage stage, Location location, Random random) {
    ...
    public Spider(Console console, Stage stage, Location location, String name, int health, int resistance,
