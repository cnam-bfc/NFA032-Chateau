...
public class Demogorgon extends Enemy {
    ...
    public Demogorgon(Console console, Stage stage, Location location, Random random) {
        super(console, stage, location, "Demogorgon"
    ...
    public Demogorgon(Console console, Stage stage, Location location, String name, int health, int resistance,
