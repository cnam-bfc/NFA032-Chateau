...
public class Demogorgon extends Enemy {
     ...
     */
    public Demogorgon(App app, Stage stage, Location location, Random random) {
        super(app, stage, location, "Demogorgon",
    ...
    /**
     * Constructeur du Demogorgon pour le génjérer de façon personnalisé
     *
     * @param app           L'application
     * @param stage         L'étage où il se situe
     * @param location      Les coordonnées où il se situe
     ...
     */
    public Demogorgon(App app, Stage stage, Location location, String name, int health, int resistance,
