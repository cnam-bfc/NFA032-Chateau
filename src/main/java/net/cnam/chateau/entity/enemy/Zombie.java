...
public class Zombie extends Enemy {
    ...
    public Zombie(Console console, Stage stage, Location location, Random random) {
    ...
    public Zombie(Console console, Stage stage, Location location, String name, int health, int resistance,
